...
#bet_scraping("dan/dan_bet.html", "dan/bet_daily.xlsx")

def saved_results(url, outfile):
    ...
    if len(browser.find_elements(By.LINK_TEXT, 'További meccsek'))>0:
        browser.find_element_by_link_text("További meccsek").click()
        time.sleep(10)
    else:
        pass
...
def ou_analization(bet, matches, outfile, comp):
    ...
    #print(df_final)
    print('Over/under analization done! Check the Excel files for the results!')
...
def half_analization(bet, matches, outfile, comp):
    ...
    df_final.insert(0, 'comp', comp)
    #print(df_final)
    print('Half analization done! Check the Excel files for the results!')
